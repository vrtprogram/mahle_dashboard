    ...
    with col1:
        ...
        with col_img_A:
            ...
            st.markdown(f"""
                ...
                <center><div>
                    <svg class="svg-container" height="260" width="450">
                        <text x="20" y="220" font-size="18rem" font-weight="bold" font-family="Arial" fill={color}>S</text>
                        <text x="220" y="30" font-size="0.85rem" font-weight="bold" fill="black">LEGEND:</text>
                        <text x="220" y="60" font-size="0.85rem" font-weight="bold" fill="red">RECORDABLE LOST TIME ENJURY</text>
                        <text x="220" y="90" font-size="0.85rem" font-weight="bold" fill="darkred">RECORDABLE ACCIDENT</text>
                        <text x="220" y="120" font-size="0.85rem" font-weight="bold" fill="orange">FIRST AID</text>
                        <text x="220" y="150" font-size="0.85rem" font-weight="bold" fill="yellow">NEAR MISS</text>
                        <text x="220" y="180" font-size="0.85rem" font-weight="bold" fill="blue">FIRE</text>
                        <text x="220" y="210" font-size="0.85rem" font-weight="bold" fill="green">NO INCIDENT</text>
                    </svg>
                </div></center>
            ...
            st.markdown(
                """<center style = "font-size:12px; height:3rem;">
                <br>
                <p>_____ days without any recordable lost time injury.</p>
                </center>
                """, unsafe_allow_html=True
            )
            st.markdown("""
            ...
            st.markdown(f"""
                <center><div>
                    <svg class="svg-container" height="260" width="450">
                        <text x="20" y="220" font-size="18rem" font-weight="bold" font-family="Arial" fill={color}>D</text>
                        <text x="250" y="30" font-size="0.9rem" font-weight="bold" fill="black">LEGEND:</text>
                        <text x="250" y="60" font-size="0.9rem" font-weight="bold" fill="green">TARGET ACHIEVED</text>
                        <text x="250" y="90" font-size="0.9rem" font-weight="bold" fill="red">TARGET MISSED</text>
                        <text x="250" y="120" font-size="0.9rem" font-weight="bold" fill="blue">PLANT OFF</text>
                    </svg>
                </center></div>
                """, unsafe_allow_html=True)
            st.markdown(
                """<center style = "font-size:12px; height:3rem;">
                <br>                
                <p>______ days since OE delivery failure. </p>
                </center>
                """, unsafe_allow_html=True
            )
            with col_img_B:
            ...
            with col_img_C:
                ...
                st.markdown(f"""
                    <center><div>
                        <svg class="svg-container" height="260" width="450">
                            <text x="10" y="220" font-size="18rem" font-weight="bold" font-family="Arial" fill={color}>Q</text>
                            <text x="250" y="30" font-size="0.9rem" font-weight="bold" fill="black">LEGEND:</text>
                            <text x="250" y="60" font-size="0.9rem" font-weight="bold" fill="green">TARGET ACHIEVED</text>
                            <text x="250" y="90" font-size="0.9rem" font-weight="bold" fill="red">TARGET MISSED</text>
                            <text x="250" y="120" font-size="0.9rem" font-weight="bold" fill="blue">PLANT OFF</text>
                    ...
                    """, unsafe_allow_html=True)
                st.markdown("""
                       <center style = "font-size:12px; height:3rem;"> <br> <p>______ days since customer complaint.</p> </center>
                   """, unsafe_allow_html=True)
                st.markdown("""
                    <style>
                    .horizental1 {
                ...
                st.markdown(f"""
                    <center><div>
                        <svg class="svg-container" height="260" width="450">
                            <text x="20" y="220" font-size="18rem" font-weight="bold" font-family="Arial" fill={color}>C</text>
                            <text x="250" y="30" font-size="0.9rem" font-weight="bold" fill="black">LEGEND:</text>
                            <text x="250" y="60" font-size="0.9rem" font-weight="bold" fill="green">TARGET ACHIEVED</text>
                            <text x="250" y="90" font-size="0.9rem" font-weight="bold" fill="red">TARGET MISSED</text>
                            <text x="250" y="120" font-size="0.9rem" font-weight="bold" fill="blue">PLANT OFF</text>
                ...
                st.markdown("""
                    <center style = "font-size:12px; height:3rem;">
                    <br>
               <p>______ days since productivity target missed. </p>
                </center>
                """, unsafe_allow_html=True)
